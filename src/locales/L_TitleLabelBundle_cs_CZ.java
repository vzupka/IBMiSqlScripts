...
public class L_TitleLabelBundle_cs_CZ extends ListResourceBundle {
    ...
    private final Object[][] contents = {
        ...
        {"SortLanguage", "CSY"},
        // U_ColumnJList
        {"TitleCol", "Sestavení seznamu sloupců"},
        {"SchemaLabel", "Vyberte nebo zapište jméno schematu."},
        {"TableLabel", "Vyberte tabulku či pohled."},
        {"DragNames", "Vyberte jména sloupců vlevo a zařaďte je přetažením vpravo."},
        {"BuildColsItem", "Sestavit seznam sloupců"},
        {"RemoveSelCols", "Odstranit vybrané položky"},
        {"SelAllItems", "Vybrat všechny položky"},
        {"TitleResCol", "Výsledný seznam sloupců"},
        {"CopyToEditor", "Označte seznam a zkopírujte do editoru."},
        {"Horiz", "Do řádku"},
        {"Append", "Přidat na konec"},
        {"HorizTip", "Seznam sloupců bude sestaven do jednoho řádku."},
        {"AppendTip", "Nový seznam sloupců bude přidán za existující."},
    };
}
