...
The application enables creating, saving and running scripts of SQL statements for the IBM DB2 for i, as well as formatting and printing of the results. 
...
Aplikace dovoluje vytvářet, ukládat a spouštět SQL skripty pro databázi IBM DB2 for i, jakož i formátovat a tisknout výsledky. 
